                   ...
                   child: Column(
                     children: [
                       IconButton(
                         ...
                         onPressed: () => _sendMessage("forward"),
                       ),
                       Row(
                         ...
                         children: <Widget>[
                           ...
                           IconButton(
                             ...
                             onPressed: () => _sendMessage("sub"),
                           ),
                         ],
                       ),
                       IconButton(
                         icon: Icon(Icons.keyboard_arrow_down),
                         onPressed: () => _sendMessage("backwards"),
                       ),
                     ],
                   ),
                 ),
